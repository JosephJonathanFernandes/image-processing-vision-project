...
if uploaded_file is not None:
    ...
    with tab1:
        ...
        with col2:
            if result is not None:
                st.image(result, caption=f"Result: {basic_op}", use_column_width=True)
    ...
    with tab2:
        ...
        with col2:
            if result is not None:
                st.image(result, caption=f"Result: {color_op}", use_column_width=True)
    ...
    with tab3:
        ...
        with col2:
            if result is not None:
                st.image(result, caption=f"Result: {edge_op}", use_column_width=True)
    ...
    with tab4:
        ...
        with col2:
            if result is not None:
                st.image(result, caption=f"Result: {morph_op}", use_column_width=True)
    ...
    with tab5:
        ...
        with col2:
            if result is not None:
                st.image(result, caption=f"Result: {effect_op}", use_column_width=True)
